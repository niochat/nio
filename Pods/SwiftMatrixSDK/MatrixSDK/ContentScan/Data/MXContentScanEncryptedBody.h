 ...
 */
@interface MXContentScanEncryptedBody : MXJSONModel

/**
 The base64-encoded string representing encrypted JSON of the original request body.
 */
@property (nonatomic) NSString *ciphertext;

/**
 The base64-encoded string representing the MAC.
 */
