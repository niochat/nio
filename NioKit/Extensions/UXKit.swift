...
//
    ...
    public extension NSColor {
        @inlinable
        func resolvedColor(with _: UXFakeTraitCollection)
            -> UXColor
        {
            self
        }
        ...
        public extension View {
            ...
            func navigationBarTitle<S: StringProtocol>(
                _ title: S, displayMode _: UXFakeDisplayMode = .inline
            ) -> some View {
                navigationTitle(title)
            }

            @inlinable
            func autocapitalization(_: UXFakeAutocapitalizationMode) -> Self {
                self
            }
        }
    #endif
